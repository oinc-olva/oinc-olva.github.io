...
def main():
    ...
    # Neem data op
    html = urllib.request.urlopen(f"https://youtube.com/channel/{ENV_VARS['youtube_channel_id']}").read().decode('utf-8')
    ...
    channel_link = {
        'url': f"https://youtube.com/channel/{ENV_VARS['youtube_channel_id']}",
        'name': 'youtube',
        'title': 'YouTube',
        'iconAvailable': True
    }
    ...
    links_html = f"<!DOCTYPE html>\n<html>\n<head>\n<title>Korte info over oinc</title>\n</head>\n<body>\n<li>Ons kanaal: <a href=\"https://youtube.com/channel/{ENV_VARS['youtube_channel_id']}\" target=\"_blank\">klik</a></li>\n"
